...
class NeuralNetwork:
    ...
    def __init__(self, option, data = []):
        if (option['mode'] == 'train'):
            ...
            self.W_hh2 =  np.random.normal(0.0, 1.0/np.sqrt(NeuralNetwork.features), (NeuralNetwork.neurons3, NeuralNetwork.neurons2)) #Weights between input and hidden layer.
            self.W_hh3 =  np.random.normal(0.0, 1.0/np.sqrt(NeuralNetwork.features), (NeuralNetwork.neurons4, NeuralNetwork.neurons3)) #Weights between input and hidden layer.
